<form action="Search" method="post" class="logs">
    ...
    <input class="fot inp" type="text" <#if isbn??>  value="${isbn}" </#if>  name="isbn" placeholder="ISBN" />
    <input class="fot inp" type="text" <#if titolo??> value="${titolo}" </#if> name="titolo" placeholder="Titolo" />
    <input class="fot inp" type="text" <#if autore??> value="${autore}" </#if> name="autore" placeholder="Autore" />
    <input class="fot inp" type="text" <#if anno_pub??> value="${anno_pub}" </#if>  name="anno_pub" placeholder="Anno pubblicazione" />
    <div class="centra">
